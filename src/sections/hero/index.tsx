      ...
      <div className="relative z-10 mx-auto w-full max-w-[1140px]">
        ...
        >
          <motion.div
            ...
            animate="visible"
          >
            <HeroContent variants={variants} />
            <HeroTechBadges reducedMotion={reducedMotion} variants={variants} />
            <HeroCtas reducedMotion={reducedMotion} variants={variants} />
            <HeroSocial reducedMotion={reducedMotion} variants={variants} />
          </motion.div>
