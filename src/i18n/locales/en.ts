...
export const en: Dictionary = {
  ...
  home: {
    ...
    solutions: {
      ...
      subtitle:
        "Ready-to-hire solutions — designed for small businesses, micro-entrepreneurs, and independent professionals.",
      ...
      items: {
        ...
        customSystem: {
          ...
          description:
            "Tailored development based on what your business actually needs.",
          features: [
            "Custom scope",
  ...
  techStack: {
    ...
    techs: {
      ...
      angular: {
        name: "Angular",
        description: "Full-featured framework for robust APIs and applications.",
